...
export const translations = {
  en: {
    siteTitle: 'Moodscape', siteSubtitle: 'Every state of mind deserves a story.',
    timeDisplay: (time: string) => time,
    stepLabels: ['Weather', 'Place', 'Mood', 'Body'],
    stepQuestions: [
      "How's the weather?", 'Where are you?', 'How are you feeling?', "How's your body?",
    ],
    stepSubtitles: {
    ...
    mood: {
      ...
      grateful: 'Grateful', hopeful: 'Hopeful', content: 'Content',
      curious: 'Curious', inspired: 'Inspired', loved: 'Loved',
    },
    body: {
    ...
    result: {
      title: "Tonight's Film", subtitle: 'Matched for your current state',
      match: '% match', why: 'Why this film?', others: 'Other films for tonight',
      ...
      restart: 'Start over', seeAnother: 'See another recommendation →',
    },
    egg: {
      line1: "You haven't pooped for 3 days.", line2: 'Maybe your body',
      line3: 'is just trying', line4: 'to hold on to something.',
      divider: '━━━━━━━━━━', film: "Today's Film", disclaimer: '(No medical advice included.)',
    },
    langSwitch: '中文', langLabel: 'EN',
  },

  zh: {
    siteTitle: '心象', siteSubtitle: '每一种心境，都值得一个故事。',
    ...
    stepLabels: ['天气', '地点', '情绪', '身体'],
    stepQuestions: ['今天天气如何？', '你在什么地方？', '你此刻的心情？', '身体感觉怎么样？'],
    ...
    mood: {
      ...
      grateful: '感恩', hopeful: '充满希望', content: '满足',
      curious: '好奇', inspired: '受启发', loved: '被爱着',
    },
    body: {
    ...
    result: {
      title: '今晚的电影', subtitle: '为你此刻的状态匹配',
      match: '% 匹配', why: '为什么是这部电影？', others: '今晚的其他选择',
      noticeTitle: '我们从不问',
      never: ['动作片', '爱情片', '惊悚片', '喜剧片'],
      instead: '我们只问，你还好吗。',
      footer: '因为人们想要的，从来不是一部「喜剧」。\n而是某种，能理解今天的感受的东西。',
      restart: '重新开始', seeAnother: '看看其他推荐 →',
    },
    egg: {
      line1: '你已经三天没拉了。', line2: '也许你的身体',
      line3: '只是在试图', line4: '留住一些什么。',
      divider: '━━━━━━━━━━', film: '今日电影', disclaimer: '（不含医学建议）',
    },
    langSwitch: 'English', langLabel: '中',
  },
};
